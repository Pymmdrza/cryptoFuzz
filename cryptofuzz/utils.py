...
class Convertor:
    ...
    def wif_to_mne(self, wif):
        return self.bytes_to_mne(self.wif_to_bytes(wif))

    def wif_to_xprv(self, wif):
        return self.bytes_to_xprv(self.wif_to_bytes(wif))

    def wif_to_xpub(self, wif):
        return self.bytes_to_xpub(self.wif_to_bytes(wif))

    def wif_to_pub(self, wif):
        return self.bytes_to_public(self.wif_to_bytes(wif)).hex()
    ...
    def short_to_bytes(self, short_str: str) -> bytes:
        ...
        :type short_str: str
        :return: A bytes representation of the short string.
        :rtype: bytes
        """
    ...
    def short_to_wif(self, short_str: str, compress: bool = False) -> str:
        return self.hex_to_wif(self.short_to_hex(short_str), compress)
